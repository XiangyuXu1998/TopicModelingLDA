########### ACMS 60890 Statistical Foundation of Data Science ###########
################################ Project ################################
###################### Joseph Steneman, Xiangyu Xu ######################
...
# 2-topic model has the smallest perplexity
...
# Response related to these 2 topics
